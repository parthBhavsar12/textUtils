    ...
    return (
        <nav className="navbar navbar-expand-lg bg-body-tertiary" data-bs-theme={theme}>
            <div className="container-fluid">
                <a className="navbar-brand" href="#">Text App</a>
                    ...
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li className="nav-item dropdown">
                            ...
                            <ul className="dropdown-menu">
                                <li>
                                    <button type="button" className="btn btn-dark mx-2" onClick={toggleTheme}>Dark
                                        <span className='mx-2'>
                                ...
                                <li>
                                    <button type="button" className="btn btn-light mx-2" onClick={toggleTheme}>Light
                                        <span className='mx-2'>
